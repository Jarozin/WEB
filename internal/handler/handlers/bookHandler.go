...
import (
	...
	jsondto "app/internal/handler/core/dto"
	jsonmodels "app/internal/handler/core/models"
	weberrs "app/internal/handler/errs"
...
func (h *Handler) getPageBooks(c *gin.Context) {
	...
	if h.isNoEmptyField(c.Query("page_number")) {
		...
		params.Offset = int((pageNumber - 1) * PageLimit)
	}
